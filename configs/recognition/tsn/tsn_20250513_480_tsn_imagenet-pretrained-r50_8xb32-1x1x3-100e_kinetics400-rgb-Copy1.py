...
data_root = 'data/train/soccer_480_train_new'
data_root_val = 'data/val/soccer_480_val_new'
ann_file_train = 'data/train/soccer_480_train_new/train_label.txt'
ann_file_val = 'data/val/soccer_480_val_new/val_label.txt'
